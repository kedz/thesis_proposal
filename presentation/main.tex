...
\title[Thesis Proposal]{Salience Estimation and Faithful Generation:\\
\textit{\small Modeling Methods for Text Summarization and Generation.}} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\input{2_feature_based_models_of_salience/main.tex}
\input{3_deep_learning_models_of_salience/main.tex}
%\input{3_1_deep_learning_sentence_salience.tex}
