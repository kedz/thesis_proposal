...
\node (file1) at (9,5.1) { \includegraphics[scale=.10]{text-document.png} };
\node (file2) at (9,4.1) { \includegraphics[scale=.10]{text-document.png} };
\node (file3) at (9,3.1) { \includegraphics[scale=.10]{text-document.png} };
\node (system) at (8.9,1.5) { \includegraphics[scale=.07]{meat-grinder.png} };
\node[text width=1cm]  at (7.5,5.1) {Document Stream};
\draw[->,black,line width=1mm] (7.7,4.5) to (7.7,3.1); 

\node[draw,rounded rectangle,blue,minimum width=1cm,line width=.5mm] at (7.75,1) 
    {\large $\cdot$ \textbf{--}};

\node[draw,rounded rectangle,blue,minimum width=1cm,line width=.5mm] at (5.75,1) 
    {\large $\cdot$ \textbf{--}};
\node[draw,rounded rectangle,blue,minimum width=1cm,line width=.5mm] at (3.75,1) 
    {\large $\cdot$ \textbf{--}};
\node[draw,rounded rectangle,blue,minimum width=1cm,line width=.5mm] at (1.75,1) 
    {\large $\cdot$ \textbf{--}};

\node (a) at (6,1.85) {Summary Updates};
\draw[->,black,line width=1mm] (a.west) to (2.8,1.85);
